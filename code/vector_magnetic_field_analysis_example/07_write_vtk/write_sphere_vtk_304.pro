...
fn = './data/aia.lev1_euv_12s.2010-11-11T060010Z.304.image_lev1.fits'
...
openw,1,'20101111_304_sphere.vtk'
...
for i=0,nlon-1 do begin
  for j=0,nlat-1 do begin   
    ...
    z=R*cos(theta)
    printf,1,x,y,z,format='(f10.2,1x,f10.2,1x,f10.2)'
  endfor
endfor
...
for i=0,nlon-2l do begin
  for j=0,nlat-2l do begin   
    printf,1,data[i,j],format='(f10.2)'
  endfor  
endfor
