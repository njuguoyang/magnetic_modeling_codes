...
restore,'./03amb_removed/smapbxyz000.sav',/ver
mapbz=smapbz
mapbx=smapbx
mapby=smapby
...
if (count eq 0) then begin
  for j=0,ssmtr[2]-1 do begin
    if (j mod 10 eq 0) then print,'Total step is:',ssmtr[2],'  Current step is:',j+1
...
plot_vmap,/over,mapbx,mapby,mapbz=mapbz,limit=180,scale=0.004,iskip=11,jskip=11,$
